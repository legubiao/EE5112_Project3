...
lbox = 0.04*2; % length of the cube
box_center = [0.4 0.46 0.46]; % (metric) world coordinates of the box center
dObs = collisionBox(lbox,lbox,lbox);  
dObs.Pose = trvec2tform(box_center);   
% Set static obstacles
world = {aObs,dObs}; % try adding more static obstacles aObs to dObs or create your own
